...
const Footer: React.FC = () => (
  <footer className="header-theme text-white">
    {' '}
    ...
    <div className="container mx-auto mt-4 flex flex-wrap items-start justify-center">
      {/* Columna de "Links relacionados" */}
      <div className="w-full md:w-1/4 lg:w-1/5">
        <h2 className="mb-3 text-sm font-medium tracking-widest text-white">
          Links relacionados
        </h2>
        <nav className="mb-5 list-none space-y-4 text-sm">
          {' '}
      ...
      <div className="mb-4 w-full px-4 md:w-1/4 lg:w-1/5">
        <h2 className="mb-3 text-sm font-medium tracking-widest text-white">
          Programas
        </h2>
        <nav className="mb-10 list-none space-y-4 text-sm">
          <li>
            <a
    ...
    <div className="top-bar">
      <div className="container mx-auto flex flex-col flex-wrap items-center justify-between px-7 py-0.5 sm:flex-row">
